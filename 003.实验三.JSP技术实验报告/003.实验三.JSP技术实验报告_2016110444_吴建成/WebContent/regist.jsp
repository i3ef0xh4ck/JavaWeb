    ...
    <body>
		...
		<div class="main">
			<div class="main-content clear">
				<div class="message">
				    <form method="post" action="doRegist.jsp" id="regist">
				    	<div class="control-group">
							<label for="username">用户名</label>
							<input type="text" id="username" name="username" placeholder="请输入5~20位用户名" onblur="checkUsername()">			
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<input type="password" id="password" name="password" placeholder="请输入8~16位英文、数字或符号的密码" onblur="checkPassword()">					
						</div>
						<div class="control-group">
							<label for="password2">重复密码</label>
							<input type="password" id="password2" name="password2" placeholder="请再次输入密码" onblur="checkPassword2()">
						</div>
						<div class="control-group">
							<label for="email">邮箱地址</label>
							<input type="email" id="email" name="email" placeholder="请输入你的邮箱地址" onblur="checkEmail()">					
						</div>
						<div class="control-group">
							<label for="other">个人简介</label>
							<textarea id="other" name="other" onblur="checkOther()"></textarea>						
						</div>
